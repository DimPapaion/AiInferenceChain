"""
Pre-Activation ResNet-18 for CIFAR-10 — He et al. (2016) "Identity Mappings in Deep Residual Networks"
BN -> ReLU -> Conv order (pre-activation).
"""
...
class PreActResNet18(nn.Module):
    ...
    def _make_layer(self, in_planes, planes, n, stride):
        layers = [PreActBlock(in_planes, planes, stride=stride)]
        for _ in range(1, n):
            layers.append(PreActBlock(planes, planes, stride=1))
