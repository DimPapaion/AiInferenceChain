...
Supports ResNet-20 (n=3) and ResNet-56 (n=9).
Architecture designed specifically for 32x32 input (no max pooling, 3x3 initial conv).
"""
...
class ResNetCIFAR(nn.Module):
    def __init__(self, n, num_classes=10):
        """
        n: number of blocks per stage. Total layers = 6n + 2.
          n=3  -> ResNet-20
          n=9  -> ResNet-56
        """
        super().__init__()
