...
const OVERVIEW_CARDS = [
  {
    ...
    body: `InferenceChain turns inference into a verifiable network action. Multiple DNN validators run the same request independently, compare outputs, and only commit a result once the network reaches Byzantine-fault-tolerant agreement.`,
  ...
  },
  {
    ...
    subtitle: 'Model matching, quorum selection, and OOD bias',
    body: `The network filters validators by model and dataset, then uses scalable quorum selection. Knowledge Self-Assessment adds OOD-aware bias so the chosen quorum is better aligned with the incoming image domain.`,
    tags: ['S-BFT', 'OOD Bias', 'Domain Awareness'],
  },
  {
    icon: '⬡',
    color: 'cyan',
    ...
    body: `The site should make three paths obvious: users who want inference, researchers who want to inspect the protocol, and operators who want to run PoS or DNN validator nodes.`,
    tags: ['Wallet', 'Explorer', 'Node Operations'],
  },
  {
    icon: '✦',
    color: 'green',
    ...
    body: `OpenAI, Ollama, or a deterministic mock provider can sit above the chain to help with routing, anomaly analysis, task decomposition, and chain explanation. If it is disabled, the protocol still works exactly the same.`,
    tags: ['LLM Orchestration', 'Ollama', 'OpenAI'],
  },
];
...
const PATHWAYS = [
  ...
  },
  {
    ...
    body: 'Use the explorer, validator dashboard, network view, and about/whitepaper area to understand how consensus, OOD scoring, and orchestration fit together.',
    points: ['Read the protocol overview in About', 'Inspect blocks and validator metrics', 'Download the technical whitepaper PDF'],
